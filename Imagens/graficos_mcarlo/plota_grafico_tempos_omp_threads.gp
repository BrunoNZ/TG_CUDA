...
plot "processados/seq_uhura.lista" using 1:3 title "[SEQ] Intel I7" w l lt 1 lw 4 lc 0,\
	"processados/omp_uhura_2threads.lista" using 1:3 title "[OMP] Intel I7 (2 Threads)" w l lt 1 lw 4 lc 1,\
	"processados/omp_uhura_4threads.lista" using 1:3 title "[OMP] Intel I7 (4 Threads)" w l lt 1 lw 4 lc 2,\
	"processados/omp_uhura_8threads.lista" using 1:3 title "[OMP] Intel I7 (8 Threads)" w l lt 1 lw 4 lc 3
