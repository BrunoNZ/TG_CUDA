...
set output "lanczos_tempos_leitura-x-cuda.eps"
...
set auto x
plot 	"../../Logs/Lanczos/processados/leitura_achel.lista_2" using 2:xtic(1) title "Leitura dos dados com o método proposto" ls 2,\
	"../../Logs/Lanczos/processados/cuda_achel.lista_2" using 2:xtic(1) title "Tempo de execução ([CUDA] Tesla C2050)" ls 5
