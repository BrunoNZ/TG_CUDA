...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Imagens/organizacao_dados_2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Imagens/comparacao_codigo_main.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{Imagens/comparacao_codigo_padrao.png}
